...
🔥 HOOK — A hook is a gap, not a fact.

A viewer stops when they go "wait, am I doing this wrong?" or "I didn't know that." in the first 1.5 seconds. The hook's job is to open that gap — between what they assume and what you're about to reveal.

How to find the gap:
- What common mistake are travelers making in this direction?
- What do most people assume that's actually wrong?
- What would surprise someone who's been researching China travel?

The gap IS the hook. If your first sentence could be any travel video, rewrite it.

Bad: "Three cities in one province." (fact, no gap)
Good: "The #1 routing mistake in Sichuan? Starting in Chengdu." (gap — they were about to do this)
